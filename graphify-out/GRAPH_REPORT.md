...
## Corpus Check
- 127 files · ~123,243 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 994 nodes · 2129 edges · 88 communities (60 shown, 28 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 238 edges (avg confidence: 0.93)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `39f37812`
...
6. `CategoryRepository` - 27 edges
7. `BudgetService` - 24 edges
8. `Base` - 23 edges
9. `Theme` - 22 edges
10. `AuthService` - 22 edges
...
Cohesion: 0.07
Nodes (55): budget_service(), current_budget(), generate_budget(), get, post, User, BudgetEnvelope, BudgetGenerateResponse (+47 more)

### Community 1 - "schemas.py"
Cohesion: 0.07
Nodes (56): create_transaction(), delete_transaction(), get_transaction(), list_transactions(), monthly_summary(), date, delete, get (+48 more)

### Community 2 - "routers/auth.py"
Cohesion: 0.10
Nodes (32): auth_service(), login(), me(), get, post, User, refresh(), register() (+24 more)

### Community 3 - "application/health.py"
Cohesion: 0.28
Nodes (12): clamp(), health_label(), health_score(), Decimal, Compute a 0-100 financial health score from five weighted components., Compare current-month expenses to previous month. Returns one of: 'decreasing',…, Generate contextual, actionable financial recommendations. Goes beyond the old…, recommendations() (+4 more)
...
Cohesion: 0.21
Nodes (17): onboarding_service(), complete(), expenses(), goals(), income(), post, User, spending_style() (+9 more)
...
### Community 9 - "CategoryRepository"
Cohesion: 0.06
Nodes (49): list_categories(), AsyncSession, get, User, create_schema(), db_session(), AsyncSession, app_error_handler() (+41 more)
...
Cohesion: 0.14
Nodes (24): contribute(), create_goal(), delete_goal(), get_goal(), list_goals(), delete, get, GoalCreate (+16 more)
...
### Community 15 - "User"
Cohesion: 0.11
Nodes (33): AsyncSession, chat_service(), current_user(), goal_service(), health_service(), AsyncSession, HTTPAuthorizationCredentials, User (+25 more)
...
- **What is the exact relationship between `Upward Chevron Brand Mark` and `Unbranded Expo Scaffold Default Artwork`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `User` connect `User` to `repositories.py`, `schemas.py`, `routers/auth.py`, `OnboardingService`, `CategoryRepository`, `GoalService`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `TransactionService` connect `schemas.py` to `repositories.py`, `application/health.py`, `TransactionRepository`, `CategoryRepository`, `dependencies.py`, `User`, `orchestrator.py`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `CategoryRepository` connect `CategoryRepository` to `repositories.py`, `schemas.py`, `routers/auth.py`, `OnboardingService`, `TransactionRepository`?**
